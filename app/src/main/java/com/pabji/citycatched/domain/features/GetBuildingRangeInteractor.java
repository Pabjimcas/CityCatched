 ...
 */
@PerActivity
public class GetBuildingRangeInteractor extends BaseInteractorImpl<MyLocation> {

    private BuildingRepository buildingRepository;

    @Inject
    public GetBuildingRangeInteractor(BuildingRepository buildingRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable<MyLocation> buildFeatureObservable() {
        return buildingRepository.getBuildingRange();
    }
}
