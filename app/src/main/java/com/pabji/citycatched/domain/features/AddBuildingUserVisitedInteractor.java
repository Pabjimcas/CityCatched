 ...
 */
@PerActivity
public class AddBuildingUserVisitedInteractor extends BaseInteractorImpl<String> {

    private BuildingRepository buildingRepository;
    private String uid;

    @Inject
    public AddBuildingUserVisitedInteractor(BuildingRepository buildingRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
        super(threadExecutor, postExecutionThread);
        this.buildingRepository = buildingRepository;
    }

    public void execute(String uid,Subscriber<String> subscriber) {
        this.uid = uid;
    ...
    protected Observable<String> buildFeatureObservable() {
        return buildingRepository.addBuildingUserVisited(uid);
    }
}
